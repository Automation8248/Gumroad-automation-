...
title_response = client.models.generate_content(model='gemini-2.5-flash', contents=title_prompt)
...
desc_response = client.models.generate_content(model='gemini-2.5-flash', contents=desc_prompt)
